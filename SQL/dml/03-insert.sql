...
('./upload/turma-galeria.png', 'Início do projeto', 'Imagem representando o início do projeto', NOW()),
('./upload/turma-galeria.png', 'Desenvolvimento', 'Imagem representando o processo de desenvolvimento', NOW()),
('./upload/turma-galeria.png', 'Entrega final', 'Imagem representando a entrega final', NOW());
...
-- 12. ASSOCIAR IMAGENS AOS DIAS DO PROJETO
