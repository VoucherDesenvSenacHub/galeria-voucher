 ...
 * @param string $placehoder (Opcional) define um texto dentro do input.
 *
 * Exemplo de uso:
 ...
 */
function inputComponent($type, $label, $name, $placehoder = null) {
   ...
   echo 
    "<div class = 'input-container'>
        ...
        <input type='$type' class='$class' name='$name'><br>
    </div>"
}
?>