    ...
    <div class="container-adm">
        ...
        <main class="main-turmas-turmas">
            ...
            <div class="tabs-adm-turmas">
                ...
                <a class="tab-adm-turmas active" href="docentes.php?id=<?= htmlspecialchars($turma_id ?? '') ?>">DOCENTES</a>
                <a class="tab-adm-turmas" href="alunos.php?id=<?= htmlspecialchars($turma_id ?? '') ?>">ALUNOS</a>
            </div>
