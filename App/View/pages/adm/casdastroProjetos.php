    ...
    <main class="layout-main main-turmas-turmas">
      ...
      <form class="form-container-projeto"
            ...
            <div class="button-projeto">
                <?php buttonComponent('secondary', 'Cancelar', false, Config::get('APP_URL') . Config::get('DIR_ADM') . 'projetos.php?id=' . $turmaId, null, '', 'back-button-js'); // Link direto para voltar ?>
